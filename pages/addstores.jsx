    ...
    <>
        <main className="container p-5">
            <div className="mb-5 text-center">
                    <h1 className="text-4xl mb-3 font-bold text-primary text-center">{"Right, here we go, let's add a new store!"}</h1>
                    <p className='text-center'>{"Select below your store's platform to integrate it with AppScenic"}</p>
            </div>
            ...
            <div className={`grid grid-cols-10 gap-4 w-full max-w-full self-center mb-5`}>
                <div className="col-span-2 card bg-white card-compact rounded-lg shadow-lg">
            ...
            <div className={`grid grid-cols-10 justify-item-center gap-4 w-full max-w-full self-center mb-5`}>
                <div className="col-span-2 card bg-white card-compact rounded-lg shadow-lg">
                <div className="text-end mb-3">
                    <p className="text-grey p-5">COMING SOON</p>
                </div>
